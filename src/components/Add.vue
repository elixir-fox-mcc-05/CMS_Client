  ...
  <div class="Add">
    <div class="form-bg">
        ...
        <form>
          ...
          <input type="text" placeholder="input image url" id="form-input" v-model="newdata.image_url">
          ...
          <div class="btn-panel">
          <button class="btn btn-primary" id="addbtn" @click.prevent="add">Add</button>
